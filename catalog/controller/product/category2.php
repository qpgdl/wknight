...
class ControllerProductCategory2 extends Controller {  
	public function index() { 
		...
		if ($category_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/error/not_found2.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/error/not_found2.tpl';
			} else {
